...
export class RespostasService {
  ...
  getAllPessoas(usuariokey) {
    return this.firebase.list(`prj/Respostas/Usuario/${usuariokey}/Pessoas/`,
  ...
  getAllQuestionarios(pessoa, usuariokey) {
    return this.firebase.list(`prj/Respostas/Usuario/${usuariokey}/Pessoas/${pessoa}/questionarios/`,
      ref => ref.orderByChild('prj')
    )
      .snapshotChanges() /* pegar as mudanças */
      .pipe(
  ...
  getAllRespostas(pessoa, questionario, usuariokey) {
    return this.firebase.list(`prj/Respostas/Usuario/${usuariokey}/Pessoas/${pessoa}/questionarios/${questionario}/Questoes`,
      ref => ref.orderByChild('prj')
    )
      .snapshotChanges() /* pegar as mudanças */
      .pipe(
